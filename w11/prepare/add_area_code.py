def main():
    try:
        ...
        # Print the numbers without the list formatter.
        new_numbers = map(add_area_code, phone_numbers)
        for new_numbers in new_numbers:
             print(new_numbers)
...
def add_area_code(phone_number):
    ...
    """
    # If the length of phone_number is less than 12 characters,
    # add the area code "208-" at the beginning of phone_number
    # and return phone_number.

    if(len(phone_number) < 12):
        return "208-" + phone_number

    # Otherwise, return phone_number.
    else:
        return phone_number
